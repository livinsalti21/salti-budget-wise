-- SECURITY FIX #4: Add comprehensive anonymous denial policies for all sensitive tables
...
BEGIN
    ...
    LOOP
        ...
        IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = table_name AND table_schema = 'public') THEN
            ...
            BEGIN
                EXECUTE format('CREATE POLICY "Deny anonymous access to %I" ON public.%I FOR ALL TO anon USING (false) WITH CHECK (false)', table_name, table_name);
